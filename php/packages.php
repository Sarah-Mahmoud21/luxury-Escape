...
<!-- User's Booked Tours Table -->
    ...
    <div class="booked-container">
        <div class="booked-container-title">
            <h2>
            <?php echo $fname."'s " ?>Booked Packages
            </h2>
        </div>
        ...
        $sqlSearch =  mysqli_query($connect,"select * FROM bookpackages,packages
         WHERE idUser='$UserIDHolder' and bookpackages.idPackage=packages.idPackage");
