...
<!-- User's Booked Tours Table -->
    ...
    <div class="booked-container">
        ...
        $sqlSearch =  mysqli_query($connect,"select * FROM users,bookpackages,packages
         WHERE bookpackages.idUser=users.id and bookpackages.idPackage=packages.idPackage");
        ...
        // SELECT `id`, `name`, `password`, `email`, `address`, `date` FROM `users` WHERE 1
          ...
          if(mysqli_num_rows($sqlSearch) > 0){
              ...
              echo "</tbody>
                ...
                echo "
                <p>No Booked Packages to show, book one? <a href ='../index2.php#packages'>booknow </a></p>";
          }
        ?>
