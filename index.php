...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="php/bookTour.php" method="post">
            <div class="inputBox">
                <h3> Where To</h3>
                <input type="text" placeholder="Country name" name="bookTourName">
            </div>
            <div class="inputBox">
                <h3> How Many</h3>
                <input type="text" placeholder="Number of Guests" name="bookTourGuests">
            </div>
            <div class="inputBox">
                <h3> Arrivals</h3>
                <input type="date" name="bookTourArrDate">
            </div>
            <div class="inputBox">
                <h3> Leaving</h3>
                <input type="date" name="bookTourLeaveDate">
            </div>
...
<section class="packages" id="packages">
    ...
    <?php
        ...
        ?>
        <!-- <div class="box">
            <img src="images/site/p-italy.jpg" alt="">
            <div class="content">
                <h3> <i class="fas fa-map-marker-alt"></i> Italy</h3>
                <p> A feast for all senses</p>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <i class="btn bookTourBtn">Book Now</i>
                <a href="html/italy.html" target="_blank" class="btn">See more</a>
            </div>
        </div>
